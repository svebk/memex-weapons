...
base_query=imagecat_host+'/solr/imagecatdev/query?q=id:/.*com%5C/armslist.*/&fq=url:/.*%5B0-9%5D%7B3,20%7D.*/&fq=mainType:(application%20text)&fq=subType:/.*ml.*/&fq=url:*&fl=url,id,contentType,outpaths,outlinks,ner_weapon_name_t_md,ner_weapon_type_ts_md,resourcename_t_md&rows='+str(nb_rows)+'&start='
