...
MEAN_TOOLS=$TOOLS
BACKEND=leveldb
DATA=/srv/skaraman/weapons/data/task1_train_jpl_weak
TRAIN_DATA_ROOT=/srv/skaraman/weapons/JPL_WeaponsImages
TRAIN_FILE=task1_train_jpl_weak.txt
TRAIN_DB_NAME=task1_train_jpl_weak_$BACKEND
MEAN_NAME=task1_jpl
